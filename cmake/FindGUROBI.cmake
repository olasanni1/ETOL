...
if(APPLE)
  ...
  set(GUROBI_NAMES libgurobi100.dylib libgurobi95.dylib libgurobi91.dylib libgurobi90.dylib libgurobi80.dylib)
  set(GUROBI_HINTS "${GUROBI_HINTS}"
	/opt/gurobi1000/linux64 /opt/gurobi912/linux64 /opt/gurobi911/linux64 /opt/gurobi901/linux64
        /opt/gurobi811/linux64 /opt/gurobi801/linux64)
elseif(UNIX)
  set(GUROBI_API libgurobi_g++5.2.a)
  set(GUROBI_NAMES libgurobi100.so libgurobi95.so libgurobi91.so libgurobi90.so libgurobi81.so libgurobi80.so)
  set(GUROBI_HINTS "${GUROBI_HINTS}"
	/opt/gurobi1000/linux64 /opt/gurobi912/linux64 /opt/gurobi911/linux64 /opt/gurobi901/linux64
        /opt/gurobi811/linux64 /opt/gurobi801/linux64)
elseif(WIN32)
  set(GUROBI_API libgurobi_c++.a)
  set(GUROBI_NAMES gurobi100.lib gurobi95.lib gurobi91.lib gurobi90.lib gurobi81.lib gurobi80.lib)
  set(GUROBI_HINTS "${GUROBI_HINTS}"
	C:/gurobi1000/win64 C:/gurobi912/win64 C:/gurobi911/win64 C:/gurob901/win64
